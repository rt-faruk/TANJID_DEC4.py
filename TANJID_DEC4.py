#SC COPY CUT BY TANJID ABAL AND OPEN SOURCE GIVEN BY TURAG AHMED AND FUCKED BY SNIGDHO
#!/usr/bin/python3
import os
try:
    import requests
...
a=requests.get("https://raw.githubusercontent.com/rt-faruk/TANJID_DEC4.py/apporved/main/250%20Tool").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
...
def approval():
	...
	if key in ress:
		...
		os.system("xdg-open https://wa.me/+8801884164749")
